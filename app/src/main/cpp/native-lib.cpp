...
#define LOGI(FORMAT,...) __android_log_print(ANDROID_LOG_INFO,"liyaan",FORMAT,##__VA_ARGS__);
#define LOGE(FORMAT,...) __android_log_print(ANDROID_LOG_ERROR,"liyaan",FORMAT,##__VA_ARGS__);
...
Java_com_liyaan_myplayermusic_MainActivity_stringFromJNI(
        JNIEnv* env,
        jobject /* this */) {
...
Java_com_liyaan_myplayermusic_PlayerMusic_nativePlayer(JNIEnv *env, jobject thiz, jstring input_,
                                                       jstring output_) {
